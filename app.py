...
student = pd.read_csv('Best_Performing_Student_Recognition_Dataset_with_Total_Score (2).csv')

# Prepare the features and target variable
X = student.drop(['Student_ID', 'Total_Score'], axis=1)
y = student['Total_Score']
